...
class _LandingPageState extends State<LandingPage> {
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          final BuildContext? rootContext = rootNavigatorKey.currentState?.overlay?.context;
  ...
  InputDecoration _field(String hint) => InputDecoration(
    ...
    enabledBorder: OutlineInputBorder(
      ...
      borderSide: const BorderSide(color: AppColors.goldLightDark, width: 2),
    ),
    focusedBorder: OutlineInputBorder(
      borderRadius: BorderRadius.circular(8),
      borderSide: const BorderSide(color: AppColors.goldLightDark, width: 3),
    ),
