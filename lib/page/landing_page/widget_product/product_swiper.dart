...
import 'package:responsive_app/page/landing_page/widget_product/product_grid.dart'; // Para reutilizar ProductCard
...
class _ProductSwiperState extends State<ProductSwiper> {
  ...
  void _scrollToCategory(String categoryName) async {
    ...
    final index =
        widget.items.indexWhere((item) => item.category == categoryName);
    if (index != -1) {
